...
| bs.resource_type                      | Ressurstype/materialtype avledet fra `LDR/6`, `007/0-1` og `008/26`: "book", "audiobook", "video", "videogame", "other". Kan kombineres med `bs.electronic` for å skille mellom elektroniske og fysiske ressurser.             | <sru-example base="mlnb" query="bs.resource_type=&quot;book&quot; AND bs.electronic=0" />          |
