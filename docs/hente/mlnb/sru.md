...
| bs.electronic                         | `1` for elektroniske ressurser (`007/0="c"`) som e-bøker, e-lydbøker, videospill osv., `0` for fysiske ressurser. | <sru-example base="mlnb" query="bs.electronic=true" />
| bs.has_cover                          | `1` for ressurser som har omslagsbilder (865), `0` for ressurser som ikke har det.                            | <sru-example base="mlnb" query="bs.has_cover=false" />                    |
